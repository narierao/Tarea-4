...
def DaySimulation():
    ...
    while actual_time < max_time:
        ...
        #print("Largo de la cola: ", len(queue_client_list))
        #print("Gente buscando en la tienda: ", len(client_looking_for))
        #print("Clientes en el sistema: ", len(queue_client_list)+ len(client_looking_for))
        # end simultation if 
        if next_event >= 12*60*60:
            ...
            return (len(attended_client), queue_mean, ) 
